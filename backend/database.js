...
if (count.c === 0) {
  ...
  const seed = [
    // ==================== LONDRINA - Elevadores ====================
    { nome: 'Ed. GENÉVE', ...defaults({ endereco: 'R. Ernâni Lacerda de Athayde, 350', faces: 2, fluxo: 30000, insercoes: 19200, lat: -23.329950, lng: -51.178355, valor: 900, publico: 'AB+', detalhes: '1 tela vertical de 24" em cada elevador (2 Elevadores) - Comercial' }, 'Elevador', 'Londrina') },
    { nome: 'PALHANO PREMIUM', ...defaults({ endereco: 'Av. Madre Leônia Milito, 1377', faces: 7, fluxo: 42000, insercoes: 54600, lat: -23.335177, lng: -51.176956, valor: 800, publico: 'AB', detalhes: '1 tela vertical de 24" em cada elevador (7 Elevadores) - Comercial' }, 'Elevador', 'Londrina') },
    { nome: 'PALHANO BUSINESS T.1', ...defaults({ endereco: 'Av. Ayrton Senna da Silva, 300', faces: 4, fluxo: 39000, insercoes: 38400, lat: -23.327921, lng: -51.177470, valor: 800, publico: 'AB', detalhes: '1 tela vertical de 24" em cada elevador (4 Elevadores) - Comercial' }, 'Elevador', 'Londrina') },
    { nome: 'PALHANO BUSINESS T.2', ...defaults({ endereco: 'Av. Ayrton Senna da Silva, 200', faces: 4, fluxo: 38000, insercoes: 38400, lat: -23.327174, lng: -51.177533, valor: 800, publico: 'AB', detalhes: '1 tela vertical de 24" em cada elevador (4 Elevadores) - Comercial' }, 'Elevador', 'Londrina') },
    { nome: 'COMERCIAL SENADOR', ...defaults({ endereco: 'Rua Senador Souza Naves, 771', faces: 1, fluxo: 30000, lat: -23.319087, lng: -51.157303, valor: 750, publico: 'AB', detalhes: '1 tela vertical 24" - Comercial' }, 'Elevador', 'Londrina') },
    { nome: 'Ed. MORADA SHANGRI-LÁ', ...defaults({ endereco: 'R. Euclides da Cunha, 530', faces: 1, fluxo: 14300, insercoes: 14600, lat: -23.298852, lng: -51.180159, valor: 700, publico: 'AB', detalhes: '1 tela vertical de 24" - Residencial' }, 'Elevador', 'Londrina') },
    { nome: 'DUQUE HALL', ...defaults({ endereco: 'Av. Duque de Caxias, 1726', faces: 2, fluxo: 30000, insercoes: 19200, lat: -23.326553, lng: -51.154402, valor: 800, publico: 'AB', detalhes: '1 tela vertical de 24" em cada elevador (2 Elevadores) - Residencial' }, 'Elevador', 'Londrina') },
    { nome: 'DUETTO RESIDENCE', ...defaults({ endereco: 'R. dos Coqueiros, 305A - Morumbi', faces: 3, fluxo: 17100, insercoes: 43800, lat: -23.315208, lng: -51.139191, valor: 800, publico: 'AB', detalhes: '1 tela vertical de 24" em cada elevador (3 Elevadores) - Residencial' }, 'Elevador', 'Londrina') },
    { nome: 'Ed. NYC PALHANO', ...defaults({ endereco: 'R. Caracas, 1255', faces: 4, fluxo: 17100, insercoes: 57600, lat: -23.332475, lng: -51.182589, valor: 800, publico: 'AB', detalhes: '1 tela vertical de 24" em cada elevador (4 Elevadores) - Residencial' }, 'Elevador', 'Londrina') },
    { nome: 'GARDEN PALHANO', ...defaults({ endereco: 'R. Ulrico Zuinglio, 500', faces: 6, fluxo: 45000, insercoes: 57600, lat: -23.333580, lng: -51.182876, valor: 900, publico: 'AB', detalhes: '1 tela vertical de 24" em cada elevador (6 Elevadores) - Residencial' }, 'Elevador', 'Londrina') },
    ...
    { nome: 'STRASSBERG', ...defaults({ endereco: 'Rod. Celso Garcia Cid, PR-323', faces: 2, fluxo: 26000, insercoes: 16200, lat: -23.184952, lng: -51.193214, valor: 980, publico: 'AB+', detalhes: '2 telas verticais 55"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'HACHIMITSU JK', ...defaults({ endereco: 'Av. Juscelino Kubitschek, 3216', faces: 2, fluxo: 10400, insercoes: 9900, lat: -23.320053, lng: -51.157305, valor: 1090, publico: 'AB+', detalhes: '2 telas verticais 55"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'HACHIMITSU ALAMEDA JARDINO', ...defaults({ endereco: 'Alameda Jardino / R. João Wyclif, 500', faces: 2, fluxo: 10400, insercoes: 11700, lat: -23.330302, lng: -51.174233, valor: 1190, publico: 'AB+', detalhes: '2 telas verticais 46"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'HACHIMITSU BELA SUÍÇA', ...defaults({ endereco: 'Rua Assunção, 331', faces: 1, fluxo: 10400, insercoes: 5460, lat: -23.333709, lng: -51.166728, valor: 1090, publico: 'AB+', detalhes: '1 tela vertical 46"' }, 'Tela Indoor', 'Londrina') },
    { nome: "ARNALDO'S", ...defaults({ endereco: 'Av. Maringá, 430', faces: 2, fluxo: 19700, insercoes: 3520, lat: -23.305070, lng: -51.178832, valor: 800, publico: 'AB', detalhes: '2 telas verticais 24"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'FRUTTARIA ALPHAVILLE', ...defaults({ endereco: 'Rua das Palmeiras, 88', faces: 1, fluxo: 9800, insercoes: 11440, lat: -23.348083, lng: -51.189826, valor: 900, publico: 'AB+', detalhes: '1 tela vertical 46"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'POSTO ALPHA (Tela Conveniência)', ...defaults({ endereco: 'Rod. Mabio Gonçalves Palhano, 1377', faces: 1, fluxo: 36000, insercoes: 9600, lat: -23.349884, lng: -51.190534, valor: 900, publico: 'AB', detalhes: '1 tela vertical 46"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'O CASARÃO', ...defaults({ endereco: 'Av. Maringá, 899', faces: 3, fluxo: 33000, insercoes: 7200, lat: -23.309448, lng: -51.177831, valor: 1900, publico: 'AB', detalhes: '1 Vídeo Wall com 3 Telas de 49"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'PANETTERIA PALHANO', ...defaults({ endereco: 'Av. Ayrton Senna da Silva, 740', faces: 6, fluxo: 15900, insercoes: 7940, lat: -23.332850, lng: -51.177733, valor: 2100, publico: 'AB', detalhes: 'Video Wall com 6 telas horizontais de 49"' }, 'Tela Indoor', 'Londrina') },
    { nome: 'LDN GRILL', ...defaults({ endereco: 'Av. Higienópolis, 964 - Centro', faces: 4, fluxo: 18200, insercoes: 21600, lat: -23.318397, lng: -51.165858, valor: 900, publico: 'AB', detalhes: 'Vídeo Wall com 4 telas horizontais de 36"' }, 'Tela Indoor', 'Londrina') },
