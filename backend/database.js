...
if (count.c === 0) {
  ...
  const seed = [
    ...
    { nome: 'POSTO MEDITERRÂNEO', ...defaults({ endereco: 'Av. Harry Prochet, 369', faces: 3, fluxo: 60000, lat: -23.3420, lng: -51.1587, valor: 3500, publico: 'A/B' }, 'Painel LED', 'Londrina') },
    { nome: 'POSTO ALPHA (LED)', ...defaults({ endereco: 'Rod. Mabio Gonçalves Palhano, 1377', faces: 1, fluxo: 35000, lat: -23.3448, lng: -51.1885, valor: 3500, publico: 'A/B' }, 'Painel LED', 'Londrina') },
    { nome: 'POSTO GASTECH', ...defaults({ endereco: 'Av. Winston Churchill - Andes', faces: 1, fluxo: 42000, lat: -23.2919, lng: -51.1731, valor: 3000, publico: 'A/B' }, 'Painel LED', 'Londrina') },
