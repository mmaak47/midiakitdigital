  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${t.bg} ${t.text}`} data-theme={isDark ? 'dark' : 'light'}>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="group fixed bottom-6 left-6 z-[9990] flex items-center gap-3 rounded-full shadow-2xl transition-shadow duration-200 hover:shadow-[0_8px_32px_rgba(37,211,102,0.45)]"
        style={{ background: '#25D366' }}
      >
        {/* ícone */}
        <span className="flex items-center justify-center w-14 h-14 rounded-full flex-shrink-0" style={{ background: '#25D366' }}>
        ...
        <span className="max-w-0 overflow-hidden whitespace-nowrap text-white text-sm font-semibold group-hover:max-w-[160px] transition-all duration-300 pr-0 group-hover:pr-4">
          Falar com comercial
        </span>
      </motion.a>
    </div>
