...
const typeColors = {
  ...
  'LED': 'bg-purple-500/10 text-purple-400 border-purple-500/20',
  'Restaurante': 'bg-amber-500/10 text-amber-400 border-amber-500/20',
  'Padaria': 'bg-yellow-500/10 text-yellow-400 border-yellow-500/20',
  'Via Pública': 'bg-green-500/10 text-green-400 border-green-500/20',
};
